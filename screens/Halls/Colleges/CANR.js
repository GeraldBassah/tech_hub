...
import {Platform,ScrollView,Image,TouchableOpacity,View,Text,TouchableHighlight,ActivityIndicator} from "react-native";


import axios from 'axios';
import SecondScreen from './SecondScreen';

export default class CANR extends Component {
    ...
    componentDidMount() {
        axios.get(`https://techhubapi.herokuapp.com/agric`)
